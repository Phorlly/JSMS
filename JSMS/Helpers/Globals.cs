...
//// Iterate over FormData entries and format them
//for (const pair of formData.entries()) {
//    // If the value is a File object, get the file name
//    const formattedValue = pair[1] instanceof File ? pair[1].name : pair[1];

//    // Add the formatted entry to the array
//    formattedEntries.push(pair[0] + ': ' + formattedValue);
//}

//// Display the formatted entries
//alert(formattedEntries.join('\n')); // Create an array to hold the formatted entries
